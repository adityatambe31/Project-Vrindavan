import { FaFacebookF, FaInstagram, FaWhatsapp, FaYoutube, FaPhoneAlt, FaEnvelope, FaClock, FaCheck } from 'react-icons/fa';
      ...
      <div className="container mx-auto flex flex-wrap justify-between items-start space-y-4 md:space-y-0">
        ...
        <div className="w-full md:w-1/3 flex flex-col items-center md:items-start mb-4 md:mb-0 text-center md:text-left">
          ...
          <p className="text-gray-400 text-sm mb-2">
            ISCKON Temple L3, Kadambari Nagari Phase 4, <br/>Bhistabag, Ahmednagar, Maharashtra 414003, India
          </p>
        ...
        <div className="w-full md:w-1/3 flex flex-col items-center md:items-end mb-4 md:mb-0">
          <div className="w-full flex flex-col md:flex-row justify-between">
            ...
            <div className="flex flex-col mb-4 md:mb-0 md:w-1/2 px-4">
              <h3 className="text-lg font-semibold mb-2 text-center md:text-left">Timings</h3>
              <ul className="text-gray-400 text-sm space-y-1">
                <li className="flex items-center"><FaClock className="mr-2" /> Samadhi Arati – 04:10AM</li>
                <li className="flex items-center"><FaClock className="mr-2" /> Mangala Arati – 04:30AM</li>
                <li className="flex items-center"><FaClock className="mr-2" /> Tulsi-Puja – 05:00AM</li>
                <li className="flex items-center"><FaClock className="mr-2" /> Sringar Darshan – 07:15AM</li>
                <li className="flex items-center"><FaClock className="mr-2" /> Guru Puja – 07:25AM</li>
                <li className="flex items-center"><FaClock className="mr-2" /> Bhagavatam Class – 08:00AM</li>
              </ul>
            </div>
            
            {/* Our Services Section */}
            <div className="flex flex-col md:w-1/2 px-10">
              <h3 className="text-lg font-semibold mb-2  md:items-end">Our Services</h3>
