              ...
              <div className="space-y-6">
                <div>
                  ...
                  <p className="text-gray-700">
                    3, Kadambari Nagari Phase 4, Bhistabag, Ahmednagar,
                    Maharashtra 414003, India
                  </p>
                </div>
                <div>
                  <h3 className="text-lg font-semibold mb-2">Home Addresss</h3>
                  <p className="text-gray-700">
                    29/2 Sriram Nagar, Near Ambika Tiles, Athare Patil School
                    Rd, Ahmednagar, Maharashtra 414003, India
                  </p>
                </div>
                <div>
          ...
          <div className="lg:col-span-1 flex justify-center">
            <div className="bg-white p-8 rounded-lg shadow-md w-full max-w-md">
              ...
              <div className="flex items-center mb-4">
                ...
                <a
                  href="https://www.google.com/maps/place/ISKCON+TEMPLE+AHMEDNAGAR/@19.1339393,74.7388064,17z/data=!4m6!3m5!1s0x3bdcba8b826480cb:0xfafaa255bc7f4684!8m2!3d19.1339393!4d74.7388064!16s%2Fg%2F11b6324_37?entry=ttu&g_ep=EgoyMDI0MDgyMS4wIKXMDSoASAFQAw%3D%3D"
                  target="_blank"
